# Sidebar · Rol Gimnasio

- **Panel visible**: `Panel Gimnasio`
- **Notas**: Despliega todos los módulos marcados para gimnasios. Algunas entradas como `Membresías & Planes` se repiten en la sección homónima y dentro de Finanzas.
...
## Finanzas
- Finanzas (`/panel-financiero-overview`)
- Membresías & Planes (`/membresias-planes`)
...
- Equipo & RRHH (`/operaciones/equipo-rrhh`)
...
- B2B / Empresas (`/b2b/empresas`)

## Multisede / Franquicias
- Multisede & Franquicias (`/multisede`)

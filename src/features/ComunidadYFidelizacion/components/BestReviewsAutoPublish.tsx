...
import { Zap, Settings, RefreshCw, CheckCircle2, TrendingUp, Funnel, Globe, Mail, Share2 } from 'lucide-react';
...
const TARGET_OPTIONS: { value: AutoPublishTarget; label: string; icon: React.ReactNode }[] = [
  { value: 'funnel', label: 'Funnels', icon: <Funnel className="w-4 h-4" /> },

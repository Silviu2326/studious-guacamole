      ...
      >
        ...
        {stage.comparison && (
          <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-slate-400">
            {stage.comparison.trendDirection === 'up' ? <TrendingUp className="w-4 h-4 text-green-500" /> : stage.comparison.trendDirection === 'down' ? <TrendingDown className="w-4 h-4 text-red-500" /> : <Minus className="w-4 h-4 text-gray-500" />}
            <span>

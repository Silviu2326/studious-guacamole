...
import { InitiativeImpactEvaluation as InitiativeImpactEvaluationType, InitiativeRepeatRecommendation } from '../types';
...
export const InitiativeImpactEvaluation: React.FC<InitiativeImpactEvaluationProps> = ({ trainerId }) => {
  const { user } = useAuth();
  const [evaluations, setEvaluations] = useState<InitiativeImpactEvaluationType[]>([]);
  ...
  const [selectedEvaluation, setSelectedEvaluation] = useState<InitiativeImpactEvaluationType | null>(null);
    ...
    <div className="space-y-6">
      <Card className="p-6 bg-gradient-to-br from-rose-50 to-orange-50 border border-rose-200">
        ...
        {evaluations.length === 0 ? (
          ...
          <Table<InitiativeImpactEvaluationType>
            data={evaluations}
            columns={[
              {
                key: 'initiativeName',

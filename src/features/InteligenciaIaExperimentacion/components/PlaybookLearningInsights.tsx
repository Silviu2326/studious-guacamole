...
import { PlaybookLearningInsights as PlaybookLearningInsightsType, PlaybookLearningProfile } from '../types';
...
export const PlaybookLearningInsights: React.FC<PlaybookLearningInsightsProps> = ({ trainerId }) => {
  const { user } = useAuth();
  const [insights, setInsights] = useState<PlaybookLearningInsightsType | null>(null);

...
import { Save, X, Plus, Target, Sparkles, Wrench, DollarSign, AlertCircle } from 'lucide-react';
    ...
    <Card className="p-6 bg-white border border-slate-200/80 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <ArrayInputSection
          ...
          icon={<Wrench size={16} className="text-indigo-600" />}
        ...
        <ArrayInputSection
          ...
          icon={<Wrench size={16} className="text-slate-500" />}

  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-4 bg-white shadow-sm">
        <h3 className="text-xl font-bold text-gray-900 mb-4">Configuración del Análisis</h3>
      ...
      <Card className="p-4 bg-white shadow-sm">
        <h3 className="text-xl font-bold text-gray-900 mb-4">Resumen de Tendencias</h3>
      ...
      <Card className="p-4 bg-white shadow-sm">
        <h3 className="text-xl font-bold text-gray-900 mb-4">Insights y Recomendaciones</h3>

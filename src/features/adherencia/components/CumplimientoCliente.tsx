  ...
  return (
    <div className="space-y-6">
      ...
      <Card variant="hover" padding="lg">
        <h3 className={`${ds.typography.h3} ${ds.color.textPrimary} ${ds.color.textPrimaryDark} mb-6`}>Seleccionar Cliente</h3>
      ...
      {clienteSeleccionado && (
        <Card variant="hover" padding="lg">
          <h3 className={`${ds.typography.h3} ${ds.color.textPrimary} ${ds.color.textPrimaryDark} mb-6`}>Sesiones de Entrenamiento</h3>

...
export const MetricasAdherencia: React.FC<Props> = ({ metricas, filtros, onFiltrosChange }) => {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="rounded-2xl bg-slate-50 ring-1 ring-slate-200 p-3">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {esEntrenador ? (
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    <Icon name="clipboard" className="w-4 h-4 inline mr-1" />
                    Tipo de Clase
                  </label>
                  <Select
        ...
        <MetricCards
          data={esEntrenador ? [
            ...
            },
            {
              ...
              value: (metricas.clientesActivos || 0).toString(),
            ...
            },
            {
              ...
              value: (metricas.clientesConBajaAdherencia || 0).toString(),
            ...
            },
            {
              ...
              value: (metricas.clasesTotales || 0).toString(),
            ...
            },
            {
              ...
              value: (metricas.clasesConBajaOcupacion || 0).toString(),
              icon: <Icon name="warning" className="w-6 h-6 text-white" />,
              color: 'error'
            }
          ]}
      ...
      {/* Resumen del Período */}
      <Card className="p-4 bg-white shadow-sm">
        <h3 className="text-xl font-bold text-gray-900 mb-6">Resumen del Período</h3>

...
export const OptimizadorAdherencia: React.FC<Props> = ({ filtros, onFiltrosChange }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`${ds.card} ${ds.cardPad}`}>
        <h3 className={`${ds.sectionTitle} mb-4`}>Resumen de Optimizaciones</h3>
      ...
      {/* Filtros */}
      <div className={`${ds.card} ${ds.cardPad}`}>
        <h3 className={`${ds.sectionTitle} mb-4`}>Filtros</h3>
      ...
      {recomendacionesFiltradas.length > 0 && (
        <div className={`${ds.card} ${ds.cardPad}`}>
          <div className="flex items-center mb-4">
            <span className="text-2xl mr-3">🎯</span>
            <h3 className={`${ds.sectionTitle}`}>Plan de Acción Sugerido</h3>
          </div>

...
/**
 * Notifica a los clientes en lista de espera que se ha liberado un slot
 */
export const notificarSlotLiberado = async (
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      // Mock implementation: retornar array vacío o simulado
      console.log(`Notificando slot liberado para cita ${cita.id} del entrenador ${entrenadorId}`);
      resolve([]);
    }, 300);
  });
};

...
import type { ConfiguracionResumenDiario as ConfiguracionResumenDiarioData } from '../types';
import {
...
export const ConfiguracionResumenDiario: React.FC = () => {
  const { user } = useAuth();
  const [configuracion, setConfiguracion] = useState<ConfiguracionResumenDiarioData | null>(null);

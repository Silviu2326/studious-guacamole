...
import type { ConfiguracionTiempoDescanso as ConfiguracionTiempoDescansoData } from '../types';
...
export const ConfiguracionTiempoDescanso: React.FC = () => {
  const { user } = useAuth();
  const [configuracion, setConfiguracion] = useState<ConfiguracionTiempoDescansoData | null>(null);

  ...
  return (
    <Card padding="lg" className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className={`${ds.typography.h3} ${ds.color.textPrimary} ${ds.color.textPrimaryDark}`}>Gestión de Horarios</h3>
        <Button variant="primary" onClick={() => setShowModal(true)}>Añadir franja</Button>
      </div>

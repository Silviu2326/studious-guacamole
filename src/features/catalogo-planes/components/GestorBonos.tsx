...
export const GestorBonos: React.FC = () => {
  ...
  const actions: TableAction<Bono>[] = [
    {
      label: 'Editar',
      icon: <Edit2 className="h-4 w-4" />,
      variant: 'secondary',
      onClick: (bono) => handleOpenEdit(bono),
    },
    {
      label: 'Duplicar',
      icon: <Copy className="h-4 w-4" />,
      variant: 'ghost',
      onClick: (bono) => handleDuplicate(bono),
    },
    {
      label: 'Desactivar',
      icon: <PowerOff className="h-4 w-4" />,
      variant: 'ghost',
      visible: (bono) => bono.estado === 'activo',
      onClick: (bono) => handleToggleEstado(bono),
    },
    {
      label: 'Activar',
      icon: <Power className="h-4 w-4" />,
      variant: 'ghost',
      visible: (bono) => bono.estado !== 'activo' && bono.estado !== 'archivado',
      onClick: (bono) => handleToggleEstado(bono),
    },
    {
      label: 'Archivar',
      ...
      variant: 'ghost',
      visible: (bono) => bono.estado !== 'archivado',
      onClick: (bono) => handleArchive(bono),
    },
    {
      label: 'Eliminar',
      icon: <Trash2 className="h-4 w-4" />,
      variant: 'destructive',
      onClick: (bono) => handleDelete(bono),
    },
  ];

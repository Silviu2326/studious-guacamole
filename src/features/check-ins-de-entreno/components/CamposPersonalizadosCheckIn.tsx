...
import { PlantillaCheckIn, PreguntaCampo } from '../api/plantillas';

interface CamposPersonalizadosProps {
  plantilla: PlantillaCheckIn;
  values: Record<string, any>;
  onChange: (values: Record<string, any>) => void;
}

export const CamposPersonalizadosCheckIn: React.FC<CamposPersonalizadosProps> = ({
  plantilla,
  values,
  onChange,
}) => {

...
import type { ConfiguracionRecordatoriosAutomaticos as ConfiguracionRecordatoriosAutomaticosData } from '../types';
...
export const ConfiguracionRecordatoriosAutomaticos: React.FC<ConfiguracionRecordatoriosAutomaticosProps> = ({
  ...
  const [configuracion, setConfiguracion] = useState<ConfiguracionRecordatoriosAutomaticosData | null>(null);

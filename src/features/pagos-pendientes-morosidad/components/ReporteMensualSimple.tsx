...
import { ReporteMensualSimple } from '../types';
...
export const ReporteMensualSimple: React.FC<ReporteMensualSimpleProps> = ({ onRefresh }) => {
  const [reporte, setReporte] = useState<ReporteMensualSimple | null>(null);
  ...
  const columnasPagosRecibidos: TableColumn<ReporteMensualSimple['pagosRecibidos'][0]>[] = [
    {
      key: 'numeroFactura',
      label: 'Factura',
      render: (_, row) => (
  ...
  const columnasPagosFaltantes: TableColumn<ReporteMensualSimple['pagosFaltantes'][0]>[] = [
    {
      key: 'numeroFactura',
      label: 'Factura',
      render: (_, row) => (

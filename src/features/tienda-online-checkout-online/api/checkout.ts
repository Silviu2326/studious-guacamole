import { DatosCheckout, Carrito, MetodoPago, MetodoPagoDetallado, ItemCarrito, Pedido, EstadoPedido, CodigoPromocional, OfertaEspecial } from '../types';
...
export async function getMetodosPago(): Promise<MetodoPagoDetallado[]> {

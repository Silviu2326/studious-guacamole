...
import { ShoppingCart, Store, Receipt, Users, Tag, Building2, Bell, Gift, Settings, ArrowLeft } from 'lucide-react';
...
export default function TiendaOnlineCheckoutOnlinePage() {
  ...
  const [currentView, setCurrentView] = useState<'menu' | 'tienda' | 'gestion'>('menu');
  ...
  const renderMenu = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <FeatureCard
        title="Tienda"
        description="Catálogo de productos, servicios y gestión de ventas"
        icon={<Store size={24} />}
        color="blue"
        onClick={() => {
        ...
        stats={[
          ...
          { label: 'Ventas mes', value: '€1.2k' }
        ]}
      />
      <FeatureCard
        title="Gestión de Tienda"
        description="Bonos, promociones, enlaces de pago y configuración"
        ...
        stats={[
          { label: 'Bonos activos', value: '24' },
          { label: 'Promociones', value: '3' }
        ]}
      />
    </div>
  );
                ...
                <Card className="p-0 bg-white shadow-sm">
                  <div className="px-4 py-3">
                    ...
                    >
                      {currentView === 'tienda' && (
                        <>
                          <button
                            ...
                            className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all whitespace-nowrap ${tabActiva === 'tienda'
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all whitespace-nowrap ${tabActiva === 'ventas'
                              ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200'
                              : 'text-slate-600 hover:text-slate-900 hover:bg-white/70'
                              }`}
                          >
                      ...
                      {currentView === 'gestion' && rol === 'entrenador' && (
                        <>
                          <button
                            onClick={() => setTabActiva('bonos')}
                            className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all whitespace-nowrap ${tabActiva === 'bonos'
                              ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200'
                              : 'text-slate-600 hover:text-slate-900 hover:bg-white/70'
                              }`}
                          >
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all whitespace-nowrap ${tabActiva === 'bonos-b2b'
                              ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200'
                              : 'text-slate-600 hover:text-slate-900 hover:bg-white/70'
                              }`}
                          >
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all whitespace-nowrap ${tabActiva === 'enlaces-pago'
                              ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200'
                              : 'text-slate-600 hover:text-slate-900 hover:bg-white/70'
                              }`}
                          >
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all whitespace-nowrap ${tabActiva === 'codigos-promocionales'
                              ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200'
                              : 'text-slate-600 hover:text-slate-900 hover:bg-white/70'
                              }`}
                          >
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all whitespace-nowrap ${tabActiva === 'recordatorios-bonos'
                              ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200'
                              : 'text-slate-600 hover:text-slate-900 hover:bg-white/70'
                              }`}
                          >
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all whitespace-nowrap ${tabActiva === 'ofertas-especiales'
                              ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200'
                              : 'text-slate-600 hover:text-slate-900 hover:bg-white/70'
                              }`}
                          >
